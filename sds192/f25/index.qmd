---
title: "SDS 192: Introduction to Data Science - by: Jericho Lawson"
...
Note that this website is still in development and will be until at least August 25th. 
...
Classes will be held on the following days/times for these sections:

- 01: Monday/Wednesday/Friday from 9:25 AM - 10:40 AM
- 02: Monday/Wednesday/Friday from 10:50 AM - 12:05 PM

SDS 100: Reproducible Scientific Computing with Data is a co-requisite for this course and designed to help support you in coding in `R`. Please note that I walk into this course with the assumption that most students have never coded before. Coding for the first time can be intimidating, but I am here to support you through the learning curve and make things fun and relevant in the process. Trial-and-error is crucial! You will make mistakes and errors a high percentage of the time, but through that, you will discover and pick up skills that will define best practices and cultivate your coding style. Through experimentation, independence, and collaborative problem-solving, these qualities will serve you well as you progress to future courses in the SDS program and/or at Smith.
...
::: float_image_right
```{r}
#| label: Jericho Lawson
#| fig-cap: Jericho Lawson (he/him/his)
#| out.width: "200px"
knitr::include_graphics("https://jericholawson.github.io/images/profile.jpg")
```
:::

Welcome to my class and I hope you all are excited (or at least geared up) for exploring the world of data science. Data is all around us. When I was about 7 or 8, the data I enjoyed watching was sports data. To my young self, seeing my favorite basketball player accumulate the statistics they did was something to marvel. That transformed over time into my curiosity to how statistics and data science can be used in various disciplines, such sports, environmental sciences, and images. As a Ph.D. student right before this semester, I worked on an alternative variable selection procedure on image data with the use of deep learning. I enjoy exploring how various statistical metrics and data can be used as a catalyst to solve many societal, environmental, and fun problems. 

As a student in my class, you will be exposed to the data science pipeline and how this can be used to drive solutions to what you see. As an instructor, I prioritize a student-centric approach, which will incorporate active learning, case studies, and open feedback as you work through th course. In-class time will involve mini-lectures, activities, group work, and labs.
...
Most course materials will be posted here on this website
...
Content and design are adapted from Lindsay Poirier. For any questions or comments on material, please email me at [jlawson01@smith.edu](mailto:jlawson01@smith.edu)
